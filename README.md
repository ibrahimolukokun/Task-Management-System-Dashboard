A task management dashboard inspired by tools like Trello and ClickUp. Built from scratch to manage project workflows, track tasks, and organize priorities using a dynamic UI layout.
