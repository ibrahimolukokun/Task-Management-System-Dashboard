    ...
    return (
        <div className="flex justify-between items-center bg-[#FAF9F8] px-8 py-4 border-b border-gray-200">
            ...
            <div className="flex items-center space-x-4">
                <i className="ri-menu-line text-gray-600 text-xl cursor-pointer"></i>
            ...
            <div className="flex items-center space-x-6">
                {/* Add Task Button */}
                <button className="flex items-center bg-bnone text-[#4E4ECA] rounded-lg px-4 py-2 border hover:text-white hover:bg-[#454589] transition-colors">
